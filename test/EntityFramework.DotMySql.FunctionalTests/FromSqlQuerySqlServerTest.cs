...
{
    public class FromSqlQuerySqlServerTest : FromSqlQueryTestBase<NorthwindQueryMySqlFixture>
    {
...
WHERE ([c].[ContactName] = [c].[CompanyName]) OR ([c].[ContactName] IS NULL AND [c].[CompanyName] IS NULL)",
        ...
        public FromSqlQuerySqlServerTest(NorthwindQueryMySqlFixture fixture)
            : base(fixture)
        {
        }
