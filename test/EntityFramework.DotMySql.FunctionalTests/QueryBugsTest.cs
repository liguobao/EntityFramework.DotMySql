...
namespace Microsoft.Data.Entity.SqlServer.FunctionalTests
{
    public class QueryBugsTest : IClassFixture<MySqlFixture>
    {
        ...
        private class MyContext603 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseMySql(MySqlTestStore.CreateConnectionString("Repro603"));
        }
        ...
        public class MyContext925 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    ...
                    .UseMySql(MySqlTestStore.CreateConnectionString("Repro925"));
...
Queen of the Andals and the Rhoynar and the First Men, Khaleesi of the Great Grass Sea, Breaker of Chains, and Mother of Dragons"
        ...
        public class MyContext963 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseMySql(MySqlTestStore.CreateConnectionString("Repro963"));
...
WHERE ([c].[FirstName] = @__firstName_0) AND ([c].[LastName] = @__8__locals1_details_LastName_1)";
        ...
        public QueryBugsTest(MySqlFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public class MyContext3758 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseMySql(MySqlTestStore.CreateConnectionString("Repro3758"));
        ...
        {
            var connectionString = MySqlTestStore.CreateConnectionString(databaseName);
            MySqlTestStore.GetOrCreateShared(databaseName, () =>
                {
