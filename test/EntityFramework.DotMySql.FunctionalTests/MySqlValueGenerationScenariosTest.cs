...
namespace Microsoft.Data.Entity.SqlServer.FunctionalTests
{
    public class MySqlValueGenerationScenariosTest
    {
        ...
        public abstract class ContextBase : DbContext
        {
            ...
            {
                var name = GetType().FullName.Substring((GetType().Namespace + nameof(MySqlValueGenerationScenariosTest)).Length + 2);
                optionsBuilder.UseMySql(MySqlTestStore.CreateConnectionString(name));
            }
        }
