...
{
    public class IncludeSqlServerTest : IncludeTestBase<NorthwindQueryMySqlFixture>
    {
        public IncludeSqlServerTest(NorthwindQueryMySqlFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
