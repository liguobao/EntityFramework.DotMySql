...
{
    public class MySqlTriggersTest : IClassFixture<MySqlTriggersTest.SqlServerTriggersFixture>, IDisposable
    {
        [Fact]
        ...
        public MySqlTriggersTest(SqlServerTriggersFixture fixture)
        {
            _fixture = fixture;
        ...
        public class SqlServerTriggersFixture
        {
            ...
            public virtual MySqlTestStore GetTestStore()
            {
...
END");
            ...
            public TriggersContext CreateContext(MySqlTestStore testStore)
            {
