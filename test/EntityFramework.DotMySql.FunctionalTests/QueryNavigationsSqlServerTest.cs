...
{
    public class QueryNavigationsSqlServerTest : QueryNavigationsTestBase<NorthwindQueryMySqlFixture>
    {
...
WHERE (
    ...
    WHERE ([o.Customer].[Country] = [od.Order.Customer].[Country]) OR ([o.Customer].[Country] IS NULL AND [od.Order.Customer].[Country] IS NULL)
        ...
        public QueryNavigationsSqlServerTest(NorthwindQueryMySqlFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
